...
#define MEM_8(addr) (*((w_uint8_t *)(addr)))//从给定的地址上获取一个字节
#define MEM_16(addr) (*((w_uint16_t *)(addr)))//从给定的地址上获取一个字
#define MEM_32(addr) (*(w_uint32_t *)(addr))//从给定的地址上获取一个双字
#define MEM_64(addr) (*(w_uint64_t *)(addr))//从给定的地址上获取一个双字
